...
<html lang="en">
  <head>
    <title>About El Hamd Store</title>
    <meta charset="utf-8">
...
else
{
  ...
  <li class='nav-item'><a href='signup.php' class='nav-link'>Sign up</a></li>";
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/image6.jpg');" data-stellar-background-ratio="0.5">
             ...
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="thumb d-sm-flex">
	            ...
	            <div class="thumb d-flex">
	            	...
	            	<a href="#" class="thumb-menu img" style="background-image: url(images/11.jpg);">
	            	</a>
