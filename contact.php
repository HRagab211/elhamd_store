...
else
{
  ...
  <li class='nav-item'><a href='signup.php' class='nav-link'>Sign up</a></li>";
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/image2.jpg');" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row d-flex align-items-stretch no-gutters">
					<div class="col-md-6 pt-5 px-2 pb-2 p-md-5 order-md-last">
						...
						<form action="./handle/hcontact.php" method="post">
      ...
      <div class="container">
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p> <span  style = "color:#c8a97e"> <b> Address :</b> </span> 52 , Bekbashi El-Essawy Miami</p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span style = "color:#c8a97e"> <b> Phone : </b> </span> <a href="tel://1234567920" style = "color:black">03 5402353</a></p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span style = "color:#c8a97e"> <b> Email : </b> </span> <a href="mailto:info@yoursite.com" style = "color:black">###@email.com</a></p>
            </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="dbox">
	            <p><span style = "color:#c8a97e"> <b> Website :</b> </span> <a href="#" style = "color:black">###.com</a></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Fashion Club</h2>
             ...
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="thumb d-sm-flex">
	            ...
	            <div class="thumb d-flex">
	            	<a href="#" class="thumb-menu img" style="background-image: url(images/7.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(images/1.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(images/10.jpg);">
	            	</a>
	            </div>
            </div>
          </div>
