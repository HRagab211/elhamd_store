...
website_head("supplier information", true);
...
<section class="py-5">
    <div class="container">
        <div class="text-center">
            <h2 class="text-capitalize" style = "margin: 30px 0 0 0;">suppliers information</h2>
        </div>
        <div class="py-5">
        ...
        if($result === false){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td><a type="button" href="./edit.php?id='.$row["Supplier_ID"].'" class="btn btn-primary">Edit</a> <a type="button" href="./delete.php?id='.$row["Supplier_ID"].'" class="btn btn-danger">Delete</a></td>
                </tr>
                ';
                $counter++;
            }
