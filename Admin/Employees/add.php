...
<section class="py-5">
    <div class="container">
        <div class="text-center">
            <h2 class="text-capitalize" style= "margin: 30px 0 0px 0px;">Add Employee information</h2>
        </div>
        <form method="POST" action="./handel_add.php">
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Employee salary</label>
